...
class TypeSeeder extends Seeder
{
    public function run(): void
    {
        $types = [
            ...
            ['group' => Type::GROUP_USER_ROLE, 'name' => 'Warehouse Manager', 'code' => 'WHM', 'level' => 2],
            ['group' => Type::GROUP_USER_ROLE, 'name' => 'Branch Manager', 'code' => 'BRM', 'level' => 2],
            ['group' => Type::GROUP_USER_ROLE, 'name' => 'Cashier', 'code' => 'CSH', 'level' => 3],
            ['group' => Type::GROUP_USER_ROLE, 'name' => 'Staff', 'code' => 'STF', 'level' => 3],
