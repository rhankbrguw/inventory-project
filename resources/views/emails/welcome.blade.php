                    ...
                    <tr>
                        <td style="padding: 32px 24px;">
                            ...
                            <p style="margin: 0 0 24px 0; font-size: 14px; line-height: 1.6; color: #475569;">
                                Akun Anda telah aktif dan siap digunakan. Sekarang Anda memiliki akses penuh ke <strong>Inventory System</strong> untuk mengelola stok cabang, transaksi kasir, dan laporan inventaris.
                            </p>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 0 auto 24px auto;">
                                <tr>
                                    <td bgcolor="#0F172A" style="background-color: #0F172A; border-radius: 8px; text-align: center;">
                                        <a href="{{ $loginUrl }}" target="_blank" style="display: inline-block; padding: 14px 28px; font-size: 14px; font-weight: 700; color: #FFFFFF; text-decoration: none; border-radius: 8px; background-color: #0F172A;">
                                            Masuk ke Dashboard
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <div style="padding-top: 16px; border-top: 1px solid #E2E8F0;">
                                ...
                                <a href="{{ $loginUrl }}" style="font-size: 12px; color: #2563EB; text-decoration: underline; word-break: break-all;">
                                    {{ $loginUrl }}
                                </a>
                            </div>
                        </td>
