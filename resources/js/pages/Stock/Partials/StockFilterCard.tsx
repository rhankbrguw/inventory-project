...
export default function StockFilterCard({
    ...
    const sortOptions = [
        ...
        { value: 'quantity_desc', label: t('ui.sort_quantity_desc') },
        { value: 'quantity_asc', label: t('ui.sort_quantity_asc') },
        { value: 'last_moved_desc', label: t('ui.sort_last_moved_desc') },
        { value: 'last_moved_asc', label: t('ui.sort_last_moved_asc') },
    ];
