...
export default function SellItemManager({
    cart, removeItem, updateItem, flushItemQuantity, processingItem, getItemQuantity, locationId, getProductPrice: _getProductPrice, ...rest
}: {
    cart: any; removeItem: any; updateItem: any; flushItemQuantity?: any; processingItem: any; getItemQuantity: any; locationId: any; getProductPrice?: any; [key: string]: unknown;
}) {
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="w-24">
                                    <Input
                                        ...
                                        onChange={(e) => updateItem(item, e.target.value.replace(/\./g, ''))}
                                        onBlur={() => flushItemQuantity?.(item.id)}
