...
export default function Create({
    ...
    const {
        cartGroups, selectedProductIds, processingItem, processingGroup,
        removeItem, removeSupplierGroup, updateCartItem, flushCartItem,
        getItemQuantity, getItemCost, totalCartItems,
    } = purchaseCartProps;

    const cartProps = {
        cartGroups, processingGroup, removeItem, removeSupplierGroup,
        updateItem: updateCartItem, flushCartItem, getItemQuantity, getItemCost,
        onCheckout: handleOpenCheckout, processingItem, totalCartItems,
        suppliers, warehouses, locations, canCheckout: canPurchaseAnywhere,
        onInternalSourceChange: handleSourceChange, selectedSourceId,
        selectedSourceType, dynamicTotal, params, setFilter,
    };
