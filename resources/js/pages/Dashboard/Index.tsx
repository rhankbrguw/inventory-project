...
export default function Index({
    ...
    const activeLocationValue = isSuperAdmin
        ? (filters.location_id || 'all')
        : (filters.location_id ? String(filters.location_id) : (availableLocations[0]?.id?.toString() || 'none'));
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-row gap-2 w-full sm:w-auto">
            ...
            <div className="relative col-span-1">
                <Select
                    ...
                    disabled={!isSuperAdmin && availableLocations.length <= 1}
                >
                    ...
                    <SelectContent>
                        ...
                        {availableLocations.length === 0 && !isSuperAdmin && (
                            <SelectItem value="none" disabled>
                                {t('ui.no_locations_assigned')}
                            </SelectItem>
                        )}
