...
export default function PaymentMethodsChart({ data, t }: { data?: any[]; t: any }) {
    const pieData = (data ?? []).map((item: any, idx: number) => ({ ...item, fill: CHART_PALETTE[idx % CHART_PALETTE.length] }));
                        ...
                        <div className="space-y-3">
                            <div className="relative flex items-center justify-center">
                                <ResponsiveContainer width="100%" height={120}>
                                    <PieChart>
                                        <Pie data={pieData} dataKey="count" nameKey="name" cx="50%" cy="50%" innerRadius={36} outerRadius={52} paddingAngle={4} strokeWidth={2} stroke={COLORS.BACKGROUND} isAnimationActive animationDuration={900}>
