...
function checkIsFiltered(params: Record<string, unknown>): boolean {
    return Object.entries(params).some(([key, filterValue]) => {
...
export function useIndexPageFilters<T extends Record<string, unknown>>(
    ...
    useEffect(() => {
        ...
        router.get(route(routeName), queryParams as any, { preserveState: true, replace: true });
    ...
    const isFiltered = checkIsFiltered(params);
